...
| mngt_sg_ssh_rule_ip               | IP Adres die toegang krijgt tot het subnet van de MANAGEMENT-PRD-VPC omgeving via SSH                                      |
...
| mngt_sg_rdp_rule_ip               | IP Adres die toegang krijgt tot het subnet van de MANAGEMENT-PRD-VPC omgeving via RDP                                      |
